        ...
        <form:form commandName="actorInfo"  action="${cp}/join" method="post" htmlEscape="true" cssClass="actorJoinForm">
            <ul>
                <lI>    
                    ...
                    <form:input path="actor.username" placeholder="영문, 숫자만 입력가능합니다."/>
                    <form:errors path="actor.username"/>
                </lI>
                <li>
                    <form:label path="email">이메일주소</form:label>
                    <form:input path="email" placeholder="email@nornenjs.com"/>
                    <form:errors path="email"/>
                </li>
                <li>
                    <form:label path="actor.password">비밀번호</form:label>
                    <form:password path="actor.password" placeholder="8자리 이상 1개 이상 문자,숫자,특수문자를 입력해주세요."/>
                    <form:errors path="actor.password"/>
                </li>
                <li>
                ...
                <li>
                    ...
                    <form:input path="lastName" placeholder="성을 입력해주세요."/>
                    <form:errors path="lastName"/>
                </li>
                <li>
                    <form:label path="firstName">이름</form:label>
                    <form:input path="firstName" placeholder="이름을 입력해주세요."/>
